...
export const BottomTubNavigation = () => {
  ...
  return (
    <Tab.Navigator initialRouteName="Character" screenOptions={{
      ...
      <Tab.Screen name="Character" component={CharacterScreen} options={{
        tabBarIcon: () => (
          <Image style={{ width: 30, height: 30 }} source={require('../../assets/images/character.png')} />
        ),
        headerTitle: () => <HeaderTitle title={'Character'} />,
      }} />
      <Tab.Screen name="Location" component={LocationScreen} options={{
        tabBarIcon: () => (
          <Image style={{ width: 30, height: 30 }} source={require('../../assets/images/location.png')} />
        ),
        headerTitle: () => <HeaderTitle title={'Location'} />,
      }} />
      <Tab.Screen name="Episode" component={EpisodeScreen} options={{
        tabBarIcon: () => (
          <Image style={{ height: 30, width: 30 }} source={require('../../assets/images/episode.png')} />
        ),
